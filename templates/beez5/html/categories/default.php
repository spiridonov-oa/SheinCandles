...
<div id="benefits">
	<ul class="benefits-content">
		<li>Мы являемся производителями, поэтому Вы получаете продукцию по самой низкой цене на рынке.</li>
		<li>Наша продукция полностью сертифицирована и выполнена из высококачественных материалов.</li>
		<li>Специальные предложения для рекламных агентств, декораторов и организаторов мероприятий.</li>
		<li>100% гарантия сроков изготовления.</li>
		<li>Система скидок для постоянных клиентов.</li>
		<li>Работаем с доставкой.</li>
	</ul>
</div>
<div class="item-page">
	<h4>Свеча</h4>
