...
<div class="browse-view">
    ...
    <?php if (!empty($this->keyword)) {
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&limitstart=0', FALSE); ?>"
              method="get">
                        ...
                        <div class="product-image center">
                            ...
                            if ($this->showRating) {
                                ...
                                if (empty($product->rating)) {
                                    ?>
                                    <span
                                        class="vote"><?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . JText::_('COM_VIRTUEMART_UNRATED') ?></span>
                                    <?php
                                } else {
                                    $ratingwidth = $product->rating * 12; //I don't use round as percetntage with works perfect, as for me
                                    ?>
                                    <span class="vote">
                                <?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . round($product->rating) . '/' . $maxrating; ?>
                                        <br/>
                                <span
                                    title=" <?php echo(JText::_("COM_VIRTUEMART_RATING_TITLE") . round($product->rating) . '/' . $maxrating) ?>"
                                    class="category-ratingbox" style="display:inline-block;">
                            ...
                            if (VmConfig::get('display_stock', 1)) { ?>
                                ...
                                <div class="paddingtop8">
                                    ...
                                    <span
                                        class="stock-level"><?php echo JText::_('COM_VIRTUEMART_STOCK_LEVEL_DISPLAY_TITLE_TIP') ?></span>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="product-description">
                            ...
                            if (!empty($product->product_sku)) {
                                ...
                                <div class="product_sku">
                                    <span
                                        class="product-prop-title"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_SKU') ?>
                                        : </span>
                            ...
                            if (!empty($product->product_width) && $product->product_width != 0) {
                                ...
                                <div class="product_width">
                                    <span
                                        class="product-prop-title"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_WIDTH') ?></span>
                            ...
                            if (!empty($product->product_height) && $product->product_height != 0) {
                                ...
                                <div class="product_height">
                                    <span
                                        class="product-prop-title"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_HEIGHT') ?></span>
                            ...
                            if (!empty($product->product_weight) && $product->product_weight != 0) {
                                ...
                                <div class="product_weight">
                                    <span
                                        class="product-prop-title"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_BURNING_TIME') ?></span>
...
<div class="vm-pagination"><?php echo $this->vmPagination->getPagesLinks (); ?><span style="float:right"><?php echo $this->vmPagination->getPagesCounter (); ?></span></div>
        <?php //**-** Описание категории под товарами
