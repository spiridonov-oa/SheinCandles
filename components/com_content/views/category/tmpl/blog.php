...
<div class="items-leading">
	<?php foreach ($this->lead_items as $item) : ?>
		...
		<h3><a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($item->slug, $item->catid)); ?>"><?php echo $item->title; ?></a></h3>
        ...
        <?php $imgfloat = (empty($images->float_intro)) ? '' : $images->float_intro; ?>
        ...
        <?php endif;
                ...
                <?php
                        ...
                        $introtext = mb_substr($introtext,0,300,'utf-8');
                ?>
